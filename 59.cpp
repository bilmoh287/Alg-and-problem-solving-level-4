...
int main()
{
	...
	cout << "\nPeriod Length is : " << GetDifferenceInDate(Period1.startDate, Period1.EndDate);
	cout << "\nPeriod Length (including End Date) is : " << GetDifferenceInDate(Period1.startDate, Period1.EndDate, true);
