...
enum enMainMenueOptions { eListClients = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClient = 4, eFindClient = 5, eShowTransactionsMenue = 6, eShowManageUserMenue = 7, eExit = 8 };

enum enMainMenuePermissions { pAll = -1, pListClients = 1, pAddNewClient = 2, pDeleteClient = 4, pUpdateClients = 8, pFindClient = 16, pTransactions = 32, pManageUsers = 64 };

enum enManageUsersMenuOptions { eListUsers = 1, eAddUser = 2, eDeleteUser = 3, eUpdateUser = 4, eFindUser = 5, eMainMenu = 6 };
...
bool FindUserByUserNameAndPsssword(string UserName, string Password, stUser& User)
{
...
void PerfromManageUsersMenueOption(enManageUsersMenuOptions ManageUsersOption)
{
...
void ShowManageUsersMenue()
{
    ...
    cout << "\t[6] MainMenu.\n";;
    cout << "===========================================\n";
    PerfromManageUsersMenueOption((enManageUsersMenuOptions)ReadManageUsersMenueOption());
}
...
{
    if (FindUserByUserNameAndPsssword(UserName, Password, CurrentUser))
        return true;
    else
        return false;
}
...
void Login()
{
    ...
    do
    {
        ...
        LoginFaied = !LoadUsersInfo(UserName, Password);
    } while (LoginFaied);
    ShowMainMenue();
}
